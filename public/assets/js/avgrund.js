(function($) {
  ...
  $(function() {
    $('#show').avgrund({
      ...
      template: '<p class="text-secondary">So implement your design and place content here! If you want to close modal, please hit "Esc", click somewhere on the screen or use special button.</p>' +
